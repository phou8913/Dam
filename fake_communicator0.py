...
class FakeGateway:
    def __init__(self):
        ...
        self.dtu_map: Dict[str, FakeDTU] = {
            "8695311000931640": FakeHumidityTempDTU("8695311000931640"),
            "8695311000935940": FakeTiltAccDTU("8695311000935940"),
            "8695311000942380": FakeWaterLevelDTU("8695311000942380"),
